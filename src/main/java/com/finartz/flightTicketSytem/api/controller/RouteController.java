...
public class RouteController {
	...
	public Route add(@RequestBody Route route) {
		route.setLandingTime(route.getLandingTime() + " PM");
		route.setDepartureTime(route.getDepartureTime()+ " PM");
	...
	@GetMapping("getByAirlineCompany")
	public List<Route> getByAirlineCompany(String companyName){
		return this.routeService.getByAirlineCompany_CompanyName(companyName);
	}
